...
#'
#' @param post_prob A numeric vector of posterior probabilities.
#' @param threshold Numerical value of the posterior probability threshold at which to
#' calculate the empirical FDR.
#'
#' @return Numerical value of the empirical false discovery rate (FDR).
#'
#' @export
#'
...
#' @param threshold Numerical value of the posterior probability threshold at which to
#' calculate the empirical FDR.
#' @param fail_idx An integer vector of the indices of observations which failed
...
#'
#' @param post_prob A numeric matrix of posterior probabilities.
#' @param threshold Numerical value of the posterior probability threshold at which to
#' calculate the empirical FDR.
...
#' @param threshold Numerical value of the posterior probability threshold at which to
#' calculate the empirical FDR.
#' @param col_names A character vector of column names (optional).
#' @param col_idxs An integer vector of column indices (optional).
#'
#' @return Numerical value of the empirical false discovery rate (FDR).
#'
