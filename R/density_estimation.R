...
#'
#' @param grp vector of group/study identifiers (common to use \code{seq(1,d)}, for \eqn{d} groups/studies).
#' @param name_cols logical indicating whether to name columns using group/study identifiers.
#'
