...
#' @export
#'
e_step_Dmat <- function(old_pi, Dmat) {
    .Call(`_primo_e_step_Dmat`, old_pi, Dmat)
}
...
#' @export
#'
e_step_Dmat_withColSums <- function(old_pi, Dmat) {
    .Call(`_primo_e_step_Dmat_withColSums`, old_pi, Dmat)
}
